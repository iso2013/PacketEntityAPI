...
public interface EntityModifier<T> {
     ...
     */
    T getValue(ModifiableEntity target);
     ...
     */
    void setValue(ModifiableEntity target, T newValue);
     ...
     */
    void unsetValue(ModifiableEntity target);
     ...
     */
    void unsetValue(ModifiableEntity target, boolean setToDefault);
     ...
     */
    boolean specifies(ModifiableEntity target);
